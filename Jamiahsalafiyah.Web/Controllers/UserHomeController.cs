using Jamiahsalafiyah.Web.ExcelConvertor;
...
namespace Jamiahsalafiyah.Web.Controllers
{
    public class UserHomeController : Controller
    {
       ...
       // private DashboardSetup setup = new DashboardSetup();
        ...
        //        DashboardClass model = new DashboardClass();
        //        model.FirstGrid = new List<DashboardJobClass>();
        //        model.FirstGrid = setup.GetAllJobs(false);
        ...
        //        DashboardClass model = new DashboardClass();
        //        model.FirstGrid = new List<DashboardJobClass>();
        //        //model.FirstGrid = setup.GetAllArchiveJobs(true);
        //        model.FirstGrid = setup.FillFirstGrid(5);
