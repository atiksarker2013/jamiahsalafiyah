...
namespace Jamiahsalafiyah.Web.ExcelConvertor
{
    public class ExcelUtility
    {
        ...
        public FileClass WriteDataTableToExcel1(System.Data.DataTable dataTable, string worksheetName, string ReporType)
        {
            ...
            try
            {
                ...
                /////////////////////
                string tempPath = @"A:\" + DateTime.Now.Hour + DateTime.Now.Minute + DateTime.Now.Second + DateTime.Now.Millisecond + "_temp";//date time added to be sure there are no name conflicts
                ...
                file.FileFormat = excelworkBook.FileFormat.ToString();
                string sd = excelworkBook.Name;//FileName
                excelworkBook.Close();
                excel.Quit();
